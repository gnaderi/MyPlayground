...
public class PopularUrl {
    public static void main(String[] argv) throws Exception {
        ...
        urlMap = urlMap.entrySet().stream().sorted(Collections.reverseOrder(Map.Entry.comparingByValue())).collect(toMap(Map.Entry::getKey, Map.Entry::getValue, (e1, e2) -> e2, LinkedHashMap::new));

 urlMap.keySet().stream().toList().subList(0,10).forEach(System.out::println);
